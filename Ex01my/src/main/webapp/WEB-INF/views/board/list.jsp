...
<main class="container">
  ...
  <c:forEach items="${list }" var="board"> 
    ...
    <a href="#" class="list-group-item list-group-item-action d-flex gap-3 py-3" onclick="request('/board/view?pageNo=${pageDto.cri.pageNo}&searchField=${pageDto.cri.searchField}&searchWord=${pageDto.cri.searchWord}', ${board.bno})" aria-current="true">
      ...
      <div class="d-flex gap-2 w-100 justify-content-between">
        ...
        <small class="opacity-50 text-nowrap">${board.regdate }</small>
      </div>
    </a>
  </c:forEach>
  <!-- 반복할 부분 -->
