...
/**
 * 스프링 MVC에서 제공하고 있는 어노테이션을 이용하여 Controller를 작성 해봅시다
 * 
 * 톰캣 서버를 실행하면 web.xml 파일의 설정을 읽어 서버를 시작합니다.
 * web.xml파일에 기술되어 있는 servlet-context.xml파일의 component-scan에 등록된 패키지를 탐색하며
 * 클래스를 조사하고  객체설정에 사용되는 어노테이션들을 가진 클래스를 객체로 생성하고 관리합니다.
 * 
...
public class MappingController {
	 ...
	 * 메서드 상단에 적용시 메서드의 URL경로를 지정
	 * 
	 * get방식과 post방식을 모두 처리하고싶은 경우, 배열로 받을 수 있습니다
	 */
	 ...
	 * 어노테이션 사용이 불가능 할 경우 스프링의 버전을 확인
	 * ✨GetMapping
	 * Get방식의 요청을 처리 합니다.
	 * 
	 * ✨파라메터의 자동수집
	 ...
	 * 단, 타입이 불일치하는 경우 400오류가 발생 할 수 있습니다.
	 */
